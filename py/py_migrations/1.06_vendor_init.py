...
if __name__ == '__main__':
    ...
    try:
        ...
        fake = Faker(False)
        vendors = [('aaaaaa@mail.ru',), ('bbbb@mail.ru',)]

        vendors_records = ", ".join(["%s"] * len(vendors))

        insert_query = (
           f"INSERT INTO vendor (email)  VALUES {vendors_records}"
        )
        print("start INSERTING")
        cursor.execute(insert_query, vendors)
